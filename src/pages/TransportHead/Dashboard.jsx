...
export default function TransportDashboard() {
    ...
    const stats = [
        { label: 'Total Buses', value: buses.length, icon: '🚌', accent: '#6c5ce7' },
        { label: 'Active Routes', value: activeBuses.length, icon: '🛣️', accent: '#00cec9' },
        { label: 'Students Enrolled', value: students.length || '—', icon: '🎓', accent: '#fd79a8' },
        { label: 'Active Drivers', value: drivers.filter(d => d.status === 'on_duty').length, icon: '🧑‍✈️', accent: '#fdcb6e' },
        { label: 'Pending Complaints', value: pendingComplaints.length, icon: '⚠️', accent: '#e17055' },
        { label: 'Total Routes', value: routes.length, icon: '📍', accent: '#00b894' },
        { label: 'Bus Change Requests', value: pendingChanges.length, icon: '🔄', accent: '#a29bfe' },
        { label: 'Visit Requests', value: pendingVisits.length, icon: '🏭', accent: '#fab1a0' },
    ];
